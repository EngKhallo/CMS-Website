                            ...
                            <div class="row align-items-center">
                                <div class="col-md-12">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">skills Content</h5>
                                    </div>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-skills"></i></a></li>
                                        <li class="breadcrumb-item"><a href="javascript:">skills</a></li>
                                        <li class="breadcrumb-item"><a href="javascript:">New skills</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
