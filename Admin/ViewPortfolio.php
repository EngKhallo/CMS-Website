                                                        ...
                                                        <tbody>
                                                            <?php while ($row = mysqli_fetch_object($result)) : ?>
                                                                <tr>
                                                                    ...
                                                                    <td><img src="../img/projects/<?php echo $row->preview_image; ?>" width="200px" alt=""></td>
                                                                    <td><img src="../img/projects/<?php echo $row->content_img1; ?>" width="200px" alt=""></td>
                                                                    <td><img src="../img/projects/<?php echo $row->content_img2; ?>" width="200px" alt=""></td>
                                                                    <td><img src="../img/projects/<?php echo $row->content_img3; ?>" width="200px" alt=""></td>
                                                                    <td><?php echo $row->project; ?></td>
                                                                    <td><?php echo $row->client; ?></td>
                                                                    <td><?php echo $row->languages; ?></td>
                                                                    <td><?php echo $row->preview; ?></td>
                                                                    <td><a href="UpdatePortfolio.php?update_id=<?php echo $row->id; ?>" class="btn btn-info update">Update</a></td>
                                                                </tr>
                                                            <?php endwhile; ?>
                                                        </tbody>
                                                    </table>
